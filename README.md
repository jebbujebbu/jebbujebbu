...
Before starting my career in IT, I was a teacher of Finnish as a second language for adult immigrants, and I also taught native Finnish in a vocational school. This experience strengthened my problem-solving, organizational, and communication skills — qualities I now bring into software development projects.

## Technical Skills I’m Learning

- **Programming Languages:** Python, C#, JavaScript, Dart, SQL
- **Web Development:** HTML, CSS, React, Angular, Vue, Svelte, Node.js, .NET, REST APIs, Responsive Design
...
- **Mood Tracker App** 
  A team project for personal mood tracking 
- **Plant Care Assistant**  
  A team project that uses Raspberry Pi and Azure cloud services to monitor light, humidity, and temperature, helping maintain plant health
...
- Open to **junior developer roles and collaborative projects**
